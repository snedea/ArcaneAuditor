"""Script functional method usage rule using unified architecture."""

from ...script.shared import ScriptRuleBase
from .functional_method_usage_detector import FunctionalMethodUsageDetector


class ScriptFunctionalMethodUsageRule(ScriptRuleBase):
    ...
    SEVERITY = "WARNING"
    DETECTOR = FunctionalMethodUsageDetector
